...
async def send_doc(client,message):
       ...
       if update_channel :
       	try:
       		...
       		await message.reply_text("Mendan foydalanish uchun O'ktam Jo'rayev O'J8 kanaliga obuna bo'ling.\n\n O'ktam Jo'rayev O'J8 kanalini tark etsangiz mendan foydalana olmaysiz.",
       		reply_to_message_id = message.id,
       		reply_markup = InlineKeyboardMarkup(
