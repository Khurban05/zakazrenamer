...
async def send_doc(client,message):
       ...
       if update_channel :
       	try:
       		...
       		await message.reply_text("Mendan foydalanish uchun Oktam Jorayev OJ8 kanaliga obuna boling.\n\n Oktam Jorayev OJ8 kanalini tark etsangiz mendan foydalana olmaysiz.",
       		reply_to_message_id = message.id,
       		reply_markup = InlineKeyboardMarkup(
